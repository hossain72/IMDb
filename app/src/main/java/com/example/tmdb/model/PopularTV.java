...
public class PopularTV extends BaseObservable implements Parcelable
{
    ...
    public final static Parcelable.Creator<PopularTV> CREATOR = new Creator<PopularTV>() {
    ...
    public static final DiffUtil.ItemCallback<PopularTV> CALLBACK = new DiffUtil.ItemCallback<PopularTV>() {
        @Override
        public boolean areItemsTheSame(@NonNull PopularTV oldItem, @NonNull PopularTV newItem) {
            return oldItem.id == newItem.id;
        }

        @Override
        public boolean areContentsTheSame(@NonNull PopularTV oldItem, @NonNull PopularTV newItem) {
            return true;
        }
    };
